...
This class of models works best for systems that have fixed behaviors. For example, a reactor
...
nuclide vector. Recipe reactors use fixed pairs of input and output recipes to represent fresh and spent
...
3\% U-235 enriched fuel, and 4\% enriched fuel might be used to get a 3.5\% enriched fuel recipe.
...
Medium fidelity models synthesize the pre-built datasets and reasonablly fast physics
...
axecution time is orders of magnitude lower than full neutron transport and multiphysics
...
\node (origen22) [process, below of = pyne]{Origen 2.2};
