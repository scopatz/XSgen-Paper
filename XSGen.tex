...
\caption{Cross Section Behavior of U235 in 3.5\% enriched LWR.
         ...
         \TODO{Create a matplotlib version of this figure and commit the
               script to the repo}}
\begin{tikzpicture}
\begin{axis}[
    xlabel={Time (days)},
...
\begin{figure}
\caption{\TODO{Convert to matplotlib} Cross Section Behavior of U238 in 3.5\% enriched LWR. The U238 is subjected to a constant flux of $3x10^14$n/s/$cm^2$.}
\begin{tikzpicture}
\begin{axis}[
    xlabel={Time (days)},
    ylabel={Cross Section (barns)},
...
reactor is 9.2\% lower in the Bright-lite model. The amount of fissile plutonium is also lower,
but within acceptable bounds (\TODO{which are?}). The lower amount of fissile plutonium leads
