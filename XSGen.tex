...
XSgen tracks a kilogram of fuel material in addition to each isotope. This information includes the criticality of the fuel bundle. This is only a single bu  
can be used to project out the discharge fluence of the fuel assembly, and therefore the output isotopic composition of the fuel bundle. 
